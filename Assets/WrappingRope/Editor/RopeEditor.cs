...
namespace WrappingRopeLibrary.Editors
{
    ...
    public class RopeEditor : Editor
    {
        ...
        // private MethodInfo doIntFieldMethod;
        // private object recycledIntEditor;

        // private void InitDoIntFieldMethod()
        // {
        //     Type editorGUIType = typeof(EditorGUI);

        //     Type RecycledTextEditorType = Assembly.GetAssembly(editorGUIType).GetType("UnityEditor.EditorGUI+RecycledTextEditor");
        //     Type[] argumentTypes = new Type[] { RecycledTextEditorType, typeof(Rect), typeof(Rect), typeof(int), typeof(float), typeof(string), typeof(GUIStyle), typeof(bool) };
        //     doIntFieldMethod = editorGUIType.GetMethod("DoFloatField", BindingFlags.NonPublic | BindingFlags.Static, null, argumentTypes, null);
        //     FieldInfo fieldInfo = editorGUIType.GetField("s_RecycledEditor", BindingFlags.NonPublic | BindingFlags.Static);
        //     recycledIntEditor = fieldInfo.GetValue(null);
        // }

        // private int MyIntFieldInternal(Rect position, Rect dragHotZone, int value, [DefaultValue("EditorStyles.numberField")]GUIStyle style)
        // {
        //     if (doIntFieldMethod == null || recycledIntEditor == null)
        //         InitDoIntFieldMethod();
        //     float fieldValue = Convert.ToSingle(value);
        //     if (doIntFieldMethod != null && recycledIntEditor != null)
        //     {
        //         int controlID = GUIUtility.GetControlID("EditorTextField".GetHashCode(), FocusType.Keyboard, position);
        //         object[] parameters = new object[] { recycledIntEditor, position, dragHotZone, controlID, value, "g7", style, true };
        //         value = (int)doIntFieldMethod.Invoke(null, parameters);
        //     }
        //     return value; // Convert.ToInt32(fieldValue);
        // }
    }
